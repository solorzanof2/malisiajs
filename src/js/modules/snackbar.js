...
var SnackbarApi = (function() {
    ...
    const show = function(message, status = Status.success) {
        new SnackBar({
            message,
            status,
        });
    ...
    SnackbarApi.prototype.default = function(message) {
        show(message);
    }
    
    SnackbarApi.prototype.success = function(message) {
        show(message, Status.success);
    }
    
    SnackbarApi.prototype.warning = function(message) {
        show(message, Status.warning);
    }
    
    SnackbarApi.prototype.info = function(message) {
        show(message, Status.info);
    }
    
    SnackbarApi.prototype.danger = function(message) {
        show(message, Status.danger);
    }
